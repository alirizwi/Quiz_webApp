...
class SubGenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub_genre" do
    assert_difference('SubGenre.count') do
      post sub_genres_url, params: { sub_genre: { genre_id: @sub_genre.genre_id, subgenrename: @sub_genre.subgenrename } }
    end
  ...
  test "should update sub_genre" do
    patch sub_genre_url(@sub_genre), params: { sub_genre: { genre_id: @sub_genre.genre_id, subgenrename: @sub_genre.subgenrename } }
